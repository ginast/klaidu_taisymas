...
class Darbuotojas(db.Model):
    ...
    departamento = db.relationship('Departamentas', backref='darbuotojai')
...
def departamentai():
    ...
    darbuotojai = Darbuotojas.query.all()
    return render_template('departamentai.html', visi_departamentai=departamentai, visi_darbuotojai=darbuotojai)
